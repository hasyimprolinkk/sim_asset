...
<body>
    ...
    <?php foreach($pemakaian as $p) : ?>
        <hr class="solid">
        <div>
            <h4 style="margin-top: 4px; margin-bottom: -15px;">Detail Pemakaian Asset</h4>
            <h4></h4>
        </div>
        <hr class="solid">
        <br>
        ...
        <table style="width: 100%;" cellpadding="5" class="table">
                <tr>
                    <th class="bordir" style="text-align: left; width: 20%;" scope="col">Asset</th>
                    <th class="bordir" style="text-align: left; width: 20%;">Tanggal Pemakaian</th>
                    <th class="bordir" style="text-align: left; width: 20%;">Tujuan Pemakaian</th>
                    <th class="bordir" style="text-align: left; width: 20%;">Deskripsi</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td class="bordir"><?= $p['nama_asset']; ?></td>
                    <td class="bordir"><?= indo_date($p['tanggal_pemakaian']); ?></td>
                    <td class="bordir"><?= $p['tujuan_pemakaian']; ?></td>
                    <td class="bordir"><?= $p['deskripsi']; ?></td>
